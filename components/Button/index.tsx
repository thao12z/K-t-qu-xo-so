...
const Button: React.FC<ButtonProps> = ({
    ...
    return (
        <Component
            className={`relative inline-flex justify-center items-center text-[0.875rem] leading-[1.25rem] font-semibold cursor-pointer transition-all ${
                isPrimary
                ...
                isSmall ? "h-9 px-5 rounded-[0.625rem]" : "h-10 px-6 rounded-xl"
